...
namespace WLRegisterDataWebsite.Blazor.Server {
    public partial class WLRegisterDataWebsiteBlazorApplication : BlazorApplication {
        public WLRegisterDataWebsiteBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void WLRegisterDataWebsiteBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
